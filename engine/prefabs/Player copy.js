...
export class Player {
    constructor(controller, person = "firstperson", world) {
        ...
        this.vel = new THREE.Vector3(0, 0, 0); // Done (PhysicsBody)
        //this.dir = new THREE.Vector3(0, -2.3, 0);
        this.dir = new THREE.Vector3(0, 0, 0);
        this.moveSpeed = 0.2; // Input? Physics?
        this.rotationSpeed = 0.05; // Input
        this.jumpSpeed = 0.15; // Input
        this.jumping = false; // Input
        this.running = false; // Input
        this.onGround = false; // Physics?
        this.height = 2.5;
